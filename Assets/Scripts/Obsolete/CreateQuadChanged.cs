...
namespace Obsolete
{
    ...
    public class CreateQuadChanged : MonoBehaviour
    {
        ...
        //public float debug;
        public List<Vector3> vertPoints = new();

        public List<Vector2> vertUV = new();
        public List<Vector3> vertEdge = new();
        ...
        private void Start()
        {
            ...
            for (var i = 0; i < vertPoints.Count; i++) points.Add(transform.Find("Point" + i).gameObject);
        ...
        private void ReStart()
        {
            ...
            if (haveEdgeCollider2D)
            {
                ...
                for (var i = 0; i < vertPoints.Count; i++) points[i] = vertPoints[i] + vertEdge[i];
