        ...
        private void InitializeReorderableList()
        {
                ...
                true, true, true)
            {
                ...
                drawElementCallback = (rect, index, _, _) =>
                {
                    ...
                    RuleTableInspector.EnsureUniqueTriggeredBy(triggeredBy);
                    RuleTableInspector.EnsureUniqueTriggeredBy(triggers);
                    //  line 3
            ...
            _eventList = new ReorderableList(serializedObject, eventListProperty, true, true, true, true)
            {
                ...
                drawElementCallback = (rect, index, _, _) =>
                {
                    ...
                    GUI.enabled = false;
                    GUI.Label(eventRect, allEvents[index].closeTime.ToString(CultureInfo.InvariantCulture), labelStyle);
                    GUI.enabled = true;
                },
