    ...
    public class TMP_TextSelector_A : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        private void LateUpdate()
        {
            ...
            if (m_isHoveringObject)
            {
                ...
                {
                    //DebugLog.Log("[" + m_TextMeshPro.textInfo.characterInfo[charIndex].character + "] has been selected.");
                ...
                if (linkIndex != -1 && linkIndex != m_selectedLink)
                {
                    ...
                    //DebugLog.Log("Link ID: \"" + linkInfo.GetLinkID() + "\"   Link Text: \"" + linkInfo.GetLinkText() + "\""); // Example of how to retrieve the Link ID and Link Text.
                ...
                if (wordIndex != -1 && wordIndex != m_lastWordIndex)
                {
                    ...
                    //DebugLog.Log("Mouse Position: " + Input.mousePosition.ToString("f3") + "  Word Position: " + wordPOS.ToString("f3"));
