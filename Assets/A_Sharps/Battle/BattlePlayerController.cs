...
public class BattlePlayerController : MonoBehaviour
{
    ...
    CircleCollider2D collideCollider;//圆形碰撞体
    BoxCollider2D checkCollider;//正方判定区域
    ...
    void Moveing()
    {
        ...
        switch (playerColor)
        {
            ...
            case BattleControl.PlayerColor.blue:
                ...
                if (infoForBoard.collider != null)
                {
                    ...
                    if (obj.transform.tag == "board" && !obj.transform.GetComponent<EdgeCollider2D>().isTrigger && infoForBoard.collider == obj.transform.GetComponent<EdgeCollider2D>() && obj.transform.GetComponent<BoardController>().canMove)
                    {
                        jumpRayDistance = 0;
                        isJump = false;
                ...
                switch (playerDir)
                {
                    case PlayerDirEnum.up:
                        ...
                        if (isJump && (!MainControl.instance.KeyArrowToControl(KeyCode.DownArrow,1) || (infoF.collider != null && infoF.collider.gameObject.tag == "frame")) && moveing.y < -0.55f)
                        {
                            jumpRayDistanceForBoard = 0.2f;
                    ...
                    case PlayerDirEnum.down:////////////////////////////////////////////////
                        ...
                        if (isJump && (!MainControl.instance.KeyArrowToControl(KeyCode.UpArrow, 1) || (infoF.collider != null && infoF.collider.gameObject.tag == "frame")) && moveing.y > 0.55f)
                        {
                            jumpRayDistanceForBoard = 0.2f;
                            moveing = new Vector3(moveing.x, 0.55f);
                            jumpFrozen = jumpFrozenMax;
                    ...
                    case PlayerDirEnum.left:////////////////////////////////////////////////
                        ...
                        if (isJump && (!MainControl.instance.KeyArrowToControl(KeyCode.RightArrow, 1) || (infoF.collider != null && infoF.collider.gameObject.tag == "frame")) && moveing.x > 0.55f)
                        {
                            jumpRayDistanceForBoard = 0.2f;
                    ...
                    case PlayerDirEnum.right:
                        ...
                        if (isJump && (!MainControl.instance.KeyArrowToControl(KeyCode.LeftArrow, 1) || (infoF.collider != null && infoF.collider.gameObject.tag == "frame")) && moveing.x < -0.55f)
                        {
                            jumpRayDistanceForBoard = 0.2f;
                            moveing = new Vector3(-0.55f, moveing.y);
                            jumpFrozen = jumpFrozenMax;
        ...
        if (isMoveX && infoMoveX.collider != null && (infoMoveX.collider.gameObject.tag == "frame" || infoMoveX.collider.gameObject.tag == "board"))
            isMoveing = false;

        if (isMoveX || isMoveY)
        {
            bool x = (isMoveX || isMoveY) && infoMoveX.collider != null && (infoMoveX.collider.gameObject.tag == "frame" || infoMoveX.collider.gameObject.tag == "board");
            bool y = (isMoveX || isMoveY) && infoMoveY.collider != null && (infoMoveY.collider.gameObject.tag == "frame" || infoMoveY.collider.gameObject.tag == "board");
        ...
        /*
        if (isMoveY && (infoMoveY.collider == null || (infoMoveX.collider != null && infoMoveX.collider.gameObject.tag != "frame" && infoMoveX.collider.gameObject.tag != "board"))
    ...
    {
        if (collision.transform.tag == "board" && collision.transform.GetComponent<EdgeCollider2D>().IsTouching(collideCollider) && playerColor == BattleControl.PlayerColor.blue)
        {
            jumpRayDistance = 0;
            isJump = false;
    ...
    {
        if (collision.transform.tag == "board" && collision.transform.GetComponent<BoardController>().canMove && playerColor == BattleControl.PlayerColor.blue)
        {
    ...
    */
    ...
    {
        if (collision.transform.tag == "board" && playerColor == BattleControl.PlayerColor.blue && !isJump)
        {
            jumpRayDistance = 0.2f;
            isJump = true;
            switch (playerDir)
