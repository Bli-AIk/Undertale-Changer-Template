...
**簡體中文**的更新計畫/更新日志**優先更新**，其他語言會在**版本號變更**時使用GPT進行翻譯。
...
- [x] 給遺跡示例場景添加可運行的謎題（拉拉杆開門）。
- [x] Ruins樹葉迷宮房間。
- [x] 接入ink語言讀取與json檢測轉換。
...
在v1.0.2的最後一個更新里，我新增了這個文件——**CHANGELOG.md**，作為更新日志記錄每次更新的內容和下次更新的計畫。
